...
<html>
    <head>
        ...
        <title>Auraquilt</title>
        <meta property="og:title" content="Auraquilt" /> 
        <meta name="twitter:title" content="Auraquilt">
        <meta name="twitter:description" content="Auraquilt">
        <meta name="twitter:image:src" content="663b87b256f16-2658723-view.webp"/>
        
        <meta property="og:description" content="Immergiti nellintimità e nelleleganza con la nostra console in rovere artigianale in una tonalità...">
        <meta name="description" content="Immergiti nellintimità e nelleleganza con la nostra console in rovere artigianale in una tonalità...">
  ...
  <div class="market-txt--otybz--section-floating-window">
    <div class="market-txt--otybz--section-basket">
      ...
      <div id="market-txt--otybz--section-basket-count">0</div>
        ...
        <div class="container content-info" style="padding-top: 50px;">
            <div class="row">
                <div class="col">
                    <div id="market-txt--otybz--section-notification-bar">
  <div class="market-txt--otybz--section-row-blok">
    <div class="market-txt--otybz--section-bar-bloks">
      <div class="market-txt--otybz--section-col-box-icon">
        <span class="market-txt--otybz--section-icon-basket-notification market-txt--otybz--section-basket-6">
          <span class="market-txt--otybz--section-basket-var1"><i class="bi bi-cart4"></i></span>
          <span class="market-txt--otybz--section-basket-var2"><i class="bi bi-basket2"></i></span>
        </span>
      </div>
      <div class="market-txt--otybz--section-col-box">
        <div id="market-txt--otybz--section-notification-text"></div>
        <div id="market-txt--otybz--section-notification-count"></div>
        <div id="market-txt--otybz--section-notification-total-price"></div>
      </div>
    </div>
    <div class="market-txt--otybz--section-col-tovar" id="market-txt--otybz--section-notification-products">
    </div>
    <div class="market-txt--otybz--section-col-btn">
      <button id="market-txt--otybz--section-go-to-basket">Vai al carrello</button>
    </div>
  </div>
</div>
                </div>
            ...
            <section class="staylPad dopolnitel-osnov">
                <div class="content-info">
                    <div class="spomijna-boxa">
                        <div class="spomijna-boxa-box">
                            <div class="spomijna-boxa-box-et">
                                <div class="spomijna-boxa-box-new">
                                    <i class="bi bi-cash-stack"></i>
                                    <a href="delivery.html">Pagamento e spedizione</a>
                                </div>
                                <div class="spomijna-boxa-box-new">
                            ...
                            <div class="spomijna-boxa-box-logo">
                        ...
                        <div class="vl"></div>
                        <div class="spomijna-boxa-box">
                                <div class="spomijna-boxa-box-main">
                                    <i class="bi bi-phone-fill"></i>
                                    <div class="spomijna-boxa-box-main-info">
                                        <div class="spomijna-boxa-box-main-info-title">È ok</div>
                                        <div>Ordina online o per telefono</div>
                                    </div>
                                </div>
                                <div class="spomijna-boxa-box-main">
                                    <i class="bi bi-truck"></i>
                                    <div class="spomijna-boxa-box-main-info">
                                        <div class="spomijna-boxa-box-main-info-title">Consegna</div>
                                        <div>Scegli il metodo di pagamento e i tempi di consegna</div>
                                    </div>
                                </div>
                                <div class="spomijna-boxa-box-main">
                                    <i class="bi bi-house"></i>
                                    <div class="spomijna-boxa-box-main-info">
                                        <div class="spomijna-boxa-box-main-info-title">Adottivo</div>
                                        <div>Ricevi il tuo ordine direttamente a casa tua</div>
                                    </div>
                                </div>        
                        </div>
                    </div>
             ...
             <section class="tovar-main staylPad">
                <div class="content-info">
                    <h2 class="stayTitl img--j3JaD--section">Catalogo</h2>
                    <div class="tovar-main-osnov">
                        <div class="tovar-main-osnov-box"> 
                            <div class="tovar market-txt--otybz--section">
                                <a href="turn-your-interior-into-work-of-art-with-the-kraft-oak-grey-console-elegance-and-sophistication-in-every-detail.html" class="tovar-img"><img class="market-txt--otybz--section-img" src="663b87b256f16-2658723-view.webp" alt="Trasforma i tuoi interni in unopera darte con la consolle in rovere kraft: eleganza e raffinatezza in ogni dettaglio"></a>
                                <div class="tovar-content">
                                    <a href="turn-your-interior-into-work-of-art-with-the-kraft-oak-grey-console-elegance-and-sophistication-in-every-detail.html" class="tovar-content-title market-txt--otybz--section-content-title">Trasforma i tuoi interni in un'opera d'arte con la consolle in rovere kraft: eleganza e raffinatezza in ogni dettaglio</a>
                                    <div class="tovar-content-osnov">
                                         <div class="tovar-content-osnov-price"> <span>Prezzo:</span> &nbsp; <div class="market-txt--otybz--section-content-price">25.79</div> €</div>
                                        <div class="catalog-content-info-code"> <span>Codice prodotto:</span> &nbsp; B56802995</div>
                                    </div>
                                    <div class="tovar-content-text">Immergiti nell'intimità e nell'eleganza con la nostra console in rovere artigianale in una tonalità di grigio. La combinazione tra la bellezza naturale del legno e il design moderno conferisce a questa consolle un fascino unico che renderà i vostri interni davvero eccellenti.
Realizzata con...</div>
                                    <div class="tovar-content-button">
                                        <a href="turn-your-interior-into-work-of-art-with-the-kraft-oak-grey-console-elegance-and-sophistication-in-every-detail.html" class="tovar-contentt-more btn button-1 market-txt--otybz--section-link">Continua a leggere...</a>
                                        
                                        <button class="tel-btn btn button-1 market-txt--otybz--section-content-buy-btn"> Comprare </button>
                                        
                                    </div>
                                </div>
                            </div>
                             <div class="tovar market-txt--otybz--section tovar-2">
                                <a href="immerse-yourself-in-the-green-magic-unique-green-stool-for-style-and-comfort.html" class="tovar-img "><img class="market-txt--otybz--section-img" src="663b87b4a4f88-8696924-view.webp" alt="Immergiti nella magia verde: uno sgabello verde unico per stile e comfort"></a>
                                <div class="tovar-content">
                                    <a href="immerse-yourself-in-the-green-magic-unique-green-stool-for-style-and-comfort.html" class="tovar-content-title market-txt--otybz--section-content-title">Immergiti nella magia verde: uno sgabello verde unico per stile e comfort</a>
                                    <div class="tovar-content-osnov">
                                         <div class="tovar-content-osnov-price"> <span>Prezzo:</span> &nbsp; <div class="market-txt--otybz--section-content-price">23.79</div> €</div>
                                        <div class="tovar-content-info-code"> <span>Codice prodotto:</span> &nbsp; Z84802912</div>
                                    </div>
                                    <div class="tovar-content-text">Immergiti nella magia del verde con il nostro bellissimo sgabello verde, che sarà l'incarnazione dello stile e del comfort nei tuoi interni. Questo sgabello non è solo un complemento d'arredo, è una vera e propria opera d'arte in grado di trasformare qualsiasi spazio in un accogliente...</div>
                                    <div class="tovar-content-button">
                                        <a href="immerse-yourself-in-the-green-magic-unique-green-stool-for-style-and-comfort.html" class="tovar-contentt-more btn button-1 market-txt--otybz--section-link">Continua a leggere...</a>
                             ...
                             <div class="tovar market-txt--otybz--section">
                                <a href="meetings-in-style-introducing-the-900-790-dining-table-in-gray-code.html" class="tovar-img"><img class="market-txt--otybz--section-img" src="photo_663b87b6af475_272644.webp" alt="Riunioni in grande stile: ecco il tavolo da pranzo 900*790 in codice grigio"></a>
                                <div class="tovar-content">
                                    <a href="meetings-in-style-introducing-the-900-790-dining-table-in-gray-code.html" class="tovar-content-title market-txt--otybz--section-content-title">Riunioni in grande stile: ecco il tavolo da pranzo 900*790 in codice grigio</a>
                                    <div class="tovar-content-osnov">
                                         <div class="tovar-content-osnov-price"> <span>Prezzo:</span> &nbsp; <div class="market-txt--otybz--section-content-price">24.99</div> €</div>
                                        <div class="tovar-content-info-code"> <span>Codice prodotto:</span> &nbsp; W36876070</div>
                                    </div>
...
Capolavoro di stile e funzionalità, il nostro tavolo da pranzo 900*790 in grigio ardesia è pensato per diventare parte integrante della tua casa, un luogo dove gusto ed eleganza si incontrano. Incarnando la perfetta combinazione di design moderno e durata, questo tavolo sarà il...</div>
                                    <div class="tovar-content-button">
                                        <a href="meetings-in-style-introducing-the-900-790-dining-table-in-gray-code.html" class="tovar-contentt-more btn button-1 market-txt--otybz--section-link">Continua a leggere...</a>
                        ...
                        <div class="tovar-main-osnov-box"> 
                            <div class="tovar market-txt--otybz--section tovar-2">
                                <a href="exquisite-masterpiece-drawer-chest-of-drawers-in-delicate-white.html" class="tovar-img"><img class="market-txt--otybz--section-img" src="portrait_663b87b8af5c1_5260433.webp" alt="Capolavoro squisito: cassettiera a 3 cassetti in bianco delicato"></a>
                                <div class="tovar-content">
                                    <a href="exquisite-masterpiece-drawer-chest-of-drawers-in-delicate-white.html" class="tovar-content-title market-txt--otybz--section-content-title">Capolavoro squisito: cassettiera a 3 cassetti in bianco delicato</a>
                                    <div class="tovar-content-osnov">
                                         <div class="tovar-content-osnov-price"> <span>Prezzo:</span> &nbsp; <div class="market-txt--otybz--section-content-price">23.99</div> €</div>
                                        <div class="tovar-content-info-code"> <span>Codice prodotto:</span> &nbsp; F44040748</div>
                                    </div>
                                    <div class="tovar-content-text">Vi presentiamo un sofisticato simbolo di eleganza e funzionalità: una cassettiera per 3 cassetti in una delicata tonalità di bianco. Questo mobile compatto ed elegante non solo aggiunge un tocco di raffinatezza ai tuoi interni, ma funge anche da ottima soluzione per organizzare lo...</div>
                                    <div class="tovar-content-button">
                                        <a href="exquisite-masterpiece-drawer-chest-of-drawers-in-delicate-white.html" class="tovar-contentt-more btn button-1 market-txt--otybz--section-link">Continua a leggere...</a>
                             ...
                             <div class="tovar market-txt--otybz--section">
                                <a href="sophisticated-elegance-introducing-the-crisp-white-bedside-table-40x40x40-cm-for-your-bedroom.html" class="tovar-img"><img class="market-txt--otybz--section-img" src="663b87bad5cf3-9484957-snapshot.webp" alt="Eleganza sofisticata: ecco il comodino Crisp White 40x40x40 cm per la tua camera da letto"></a>
                                <div class="tovar-content">
                                    <a href="sophisticated-elegance-introducing-the-crisp-white-bedside-table-40x40x40-cm-for-your-bedroom.html" class="tovar-content-title market-txt--otybz--section-content-title">Eleganza sofisticata: ecco il comodino Crisp White 40x40x40 cm per la tua camera da letto</a>
                                    <div class="tovar-content-osnov">
                                         <div class="tovar-content-osnov-price"> <span>Prezzo:</span> &nbsp; <div class="market-txt--otybz--section-content-price">19.89</div> €</div>
                                        <div class="tovar-content-info-code"> <span>Codice prodotto:</span> &nbsp; F18400761</div>
                                    </div>
                                    <div class="tovar-content-text">Aprite le vostre serate con la luce soffusa dello stile elegante con il nostro bellissimo comodino di 40x40x40 cm in una sofisticata tonalità bianca come la neve. Questa squisita aggiunta al tuo arredamento promette di portare un tocco di freschezza e raffinatezza alla tua camera da...</div>
                                    <div class="tovar-content-button">
                                        <a href="sophisticated-elegance-introducing-the-crisp-white-bedside-table-40x40x40-cm-for-your-bedroom.html" class="tovar-contentt-more btn button-1 market-txt--otybz--section-link">Continua a leggere...</a>
                             ...
                             <div class="tovar market-txt--otybz--section tovar-2">
                                <a href="an-exquisite-masterpiece-of-style-velour-anti-claw-pouf-44-cm-is-your-key-to-luxury-and-comfort.html" class="tovar-img"><img class="market-txt--otybz--section-img" src="view_663b87bcdf253_1718004.webp" alt="Uno squisito capolavoro di stile: il pouf antiartiglio in velluto 44 cm è la chiave del lusso e del comfort"></a>
                                <div class="tovar-content">
                                    <a href="an-exquisite-masterpiece-of-style-velour-anti-claw-pouf-44-cm-is-your-key-to-luxury-and-comfort.html" class="tovar-content-title market-txt--otybz--section-content-title">Uno squisito capolavoro di stile: il pouf antiartiglio in velluto 44 cm è la chiave del lusso e del comfort</a>
                                    <div class="tovar-content-osnov">
                                         <div class="tovar-content-osnov-price"> <span>Prezzo:</span> &nbsp; <div class="market-txt--otybz--section-content-price">15.79</div> €</div>
                                        <div class="tovar-content-osnov-code"> <span>Codice prodotto:</span> &nbsp; R53268950</div>
                                    </div>
                                    <div class="tovar-content-text">Apri le porte al mondo del lusso e del comfort ai tuoi interni con il nostro magnifico Pouf in velluto giallo-antiartiglio. Questo elegante accessorio, che misura 44 cm, non solo trasforma il tuo spazio, ma offre anche un comfort e una funzionalità senza pari.
Il pregiato materiale velluto...</div>
                                    <div class="tovar-content-button">
                                        <a href="an-exquisite-masterpiece-of-style-velour-anti-claw-pouf-44-cm-is-your-key-to-luxury-and-comfort.html" class="tovar-content-more btn button-1 market-txt--otybz--section-link">Continua a leggere...</a>
        ...
        <section class="change">
            <section id="section-1" class="sale-main staylPad">
                <div class="content-info ">
                    <div class="sale-osnov header-WNfBl-style">
                        <div class="sale-info-1">
                            <div class="sale-info-1-dis">Sconto</div>
                            <div class="sale-info-1-num"> - 5 %</div>
                            
                        </div>
                        <div class="sale-img">
                            <img src="bg/0_vectimg.svg" alt="">
                        </div>
                        <div class="sale-info-2">
                             <div class="sale-info-2-dabl">
             ...
             <section id="section-2" class="reviews-main staylPad">
                <div class="content-info">
                    <div class="mennyat">
                        <div class="bloc-box-1">
                            <h2 class="stayTitl">Recensioni</h2>
                            <div class="review-box-new">
                                <div class="review">
                                    <div class="review-img blokc "><i class="bi bi-person-circle"></i></div>
                                    <div class="review-box ">
                                        <div class="review-bop">
                                            <div class="review-name">Stacey Terry</div>
                                            04.25.2024
                                        </div>
                                        <div class="review-star"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                                        <div class="review-text">Ciao! Il mio acquisto è stato semplice e veloce e il prodotto è completamente come descritto. Grazie mille!</div>
                                    </div>
                                </div>
                                <div class="review">
                                    <div class="review-img blokc"><i class="bi bi-person-circle"></i></div>
                                    <div class="review-box ">
                                        <div class="review-bop">
                                            <div class="review-name">Malcolm Sinclair</div>
                                            05.05.2024
                                        </div>
                                        <div class="review-star"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-half"></i></div>
                                        <div class="review-text">Ciao! Il prodotto corrisponde alla descrizione, non ingannato. Lo consiglierò ai miei amici.</div>
                                    </div>
                                </div>
                                <div class="review blokc">
                                    ...
                                    <div class="review-box ">
                                        <div class="review-bop">
                                            <div class="review-name">Perry Fuller</div>
                                            05.06.2024
                                        </div>
                                        <div class="review-star"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
                                        <div class="review-text">Ciao! Vorrei esprimere la mia gratitudine per l'efficienza nell'elaborazione dell'ordine e nella consegna. Tutto è andato liscio e senza problemi.</div>
                                    </div>
                                </div>
                                <div>
                                    <div id="output"></div>
                        ...
                        <div class="bloc-box-1 bloc-img-rew">
                            <img src="gallery/0-gallery.jpg" alt="" class="one-image">
                            <img src="gallery/1-gallery.jpg" alt="" class="two-image">
                            <img src="gallery/2-gallery.jpg" alt="" class="three-image">
                        </div>
                    </div>
...
if(notificationBarButton != null){
  notificationBarButton.addEventListener("click", showCartModal);
        ...
        <script>
            ...
            let title = $(this).parents('.tovar').find('.tovar-content-title').text();
        ...
        <script>
            ...
            if($('.tovar-main-osnov-box').css('flex-direction') == 'row'){
             $('.tovar').css('flex-direction','column');
            }
            if($('.tovar-main-osnov-box').css('flex-direction') == 'column'){
             $('.tovar').css('flex-direction','row');
            }
            if($('.tovar').css('flex-direction') == 'row'){
             $('.tovar-2').css('flex-direction','row-reverse');
            }
             if($('.tovar').css('flex-direction') == 'column'){
             $('.tovar-content-osnov').css('flex-direction','column');
            }
        </script>
        ...
        if (document.getElementById('tovvar1')) {
        document.getElementById('tovvar1').onclick = function() {
            document.querySelector('.write').hidden = true;
        };
        }
        if (document.getElementById('tovvar2')) {
        document.getElementById('tovvar2').onclick = function() {
            document.querySelector('.write').hidden = true;
        };
        }
        if (document.getElementById('tovvar3')) {
        document.getElementById('tovvar3').onclick = function() {
            document.querySelector('.write').hidden = true;
        };
        }
        if (document.getElementById('tovvar4')) {
        document.getElementById('tovvar4').onclick = function() {
            document.querySelector('.write').hidden = true;
        };
        }
        if (document.getElementById('tovvar5')) {
        document.getElementById('tovvar5').onclick = function() {
            document.querySelector('.write').hidden = true;
        };
        }
        if (document.getElementById('tovvar6')) {
        document.getElementById('tovvar6').onclick = function() {
            document.querySelector('.write').hidden = true;
        };
        }
